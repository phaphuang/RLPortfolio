...
class Poloniex:
    ...
    def api(self, command, args=None):
        ...
        if command in PUBLIC_COMMANDS:
            ...
            # print(json.loads(ret.read().decode(encoding='UTF-8'))) # 'BTC_BTS': {'BTC': '0.04432132', 'BTS': '60293.07423327'}, 'BTC_DASH': {'BTC': '1.97374871', 'DASH': '584.32468181'}, 'BTC_DOGE': {'BTC': '10.39228267', 'DOGE': '2846298.30814701'}
